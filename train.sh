...
python -m torch.distributed.launch --nproc_per_node=2 --use_env main.py --model deit_ms_tiny_patch16_224 --batch-size 256 --data-path ../../data/cifar100 --data-set CIFAR --input-size 32 --output_dir ./exp/deit_ms_tiny_patch16_32-cifar-bs256-baseline --num_workers 10 --ms_policy config/policy_tiny-baseline.txt
...
#python -m torch.distributed.launch --nproc_per_node=2 --use_env main.py --model deit_ms_tiny_patch16_224 --batch-size 256 --data-path ../../data/cifar100 --data-set CIFAR --input-size 32 --output_dir ./exp/deit_ms_tiny_patch16_32-cifar-bs256-ALL8-stable5 --num_workers 10 --ms_policy config/policy_tiny-8bit.txt
